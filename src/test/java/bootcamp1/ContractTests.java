...
public class ContractTests {
    ...
    private TokenState tokenState = new TokenState(alice.getParty(), bob.getParty(), 1L);
    ...
    public void tokenContractRequiresTheTransactionsOutputToHaveAPositiveAmount() {
        TokenState zeroTokenState = new TokenState(alice.getParty(), bob.getParty(), 0L);
        TokenState negativeTokenState = new TokenState(alice.getParty(), bob.getParty(), -1L);
        TokenState positiveTokenState = new TokenState(alice.getParty(), bob.getParty(), 2L);
    ...
    public void tokenContractRequiresTheIssuerToBeARequiredSignerInTheTransaction() {
        TokenState tokenStateWhereBobIsIssuer = new TokenState(bob.getParty(), alice.getParty(), 1L);
